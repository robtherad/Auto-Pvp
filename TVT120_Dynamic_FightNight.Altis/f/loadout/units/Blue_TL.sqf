...
// Add items
if ((s_loadout_map isEqualTo 0) or (s_loadout_map isEqualTo 1)) then {
    player linkItem "ItemMap";
    if ((s_loadout_gps isEqualTo 0) or (s_loadout_gps isEqualTo 1)) then {player linkItem "ItemGPS";}; 
};
player linkItem "ItemCompass";
player linkItem "ItemWatch";
if ((s_loadout_radio isEqualTo 0) or (s_loadout_radio isEqualTo 1)) then {
